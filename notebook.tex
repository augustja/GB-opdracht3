...
\end{Verbatim}
    ...
    \subsection{Query boom 1}\label{query-boom-1}
...
grafiek.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{n}{column\PYZus{}names\PYZus{}vis} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{players}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{year}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}16}]:} \PY{c+c1}{\PYZsh{} Maak hier je eerste optimalisatie}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}17}]:} \PY{n}{username} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{root}\PY{l+s+s1}{\PYZsq{}}      \PY{c+c1}{\PYZsh{} Vervang dit als je via een andere user queries stuurt}
         \PY{n}{hostname} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{localhost}\PY{l+s+s1}{\PYZsq{}} \PY{c+c1}{\PYZsh{} Als je een databank lokaal draait, is dit localhost.}
         \PY{n}{db} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{lahman2016test}\PY{l+s+s1}{\PYZsq{}}      \PY{c+c1}{\PYZsh{} Naam van de gegevensbank op je XAMPP Mysql server}
...
········
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}18}]:} \PY{c+c1}{\PYZsh{} De voorbeeldquery heeft dezelfde kolomnamen als query 1, dus we gebruiken die}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}18}]:}    players  year
         0      115  1871
         1      143  1872
         2      122  1873
         3      120  1874
...
\end{Verbatim}
    ...
    \begin{longtable}[]{@{}l@{}}
\toprule
Plot 2: Evolutie aantal actieve ploegen\tabularnewline
\bottomrule
\end{longtable}

    De volgende grafiek toont het aantal ploegen dat elk jaar acief is.
Beginnend vanaf het jaar 1871 tot 2016

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}19}]:} \PY{n}{column\PYZus{}names\PYZus{}vis2} \PY{o}{=}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Teams}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{c+c1}{\PYZsh{} Maak hier je eerste optimalisatie}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}21}]:} \PY{n}{username} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{root}\PY{l+s+s1}{\PYZsq{}}      \PY{c+c1}{\PYZsh{} Vervang dit als je via een andere user queries stuurt}
         \PY{n}{hostname} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{localhost}\PY{l+s+s1}{\PYZsq{}} \PY{c+c1}{\PYZsh{} Als je een databank lokaal draait, is dit localhost.}
         \PY{n}{db} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{lahman2016test}\PY{l+s+s1}{\PYZsq{}}      \PY{c+c1}{\PYZsh{} Naam van de gegevensbank op je XAMPP Mysql server}
...
········
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}22}]:} \PY{c+c1}{\PYZsh{} De voorbeeldquery heeft dezelfde kolomnamen als query 1, dus we gebruiken die}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}22}]:}    Teams
         0      2
         1      2
         2      2
         3      2
...
\end{Verbatim}
    ...
    \begin{longtable}[]{@{}l@{}}
\toprule
Plot 3: Aantal gespeelde games per stadium gedurende een bepaald
jaar\tabularnewline
\bottomrule
\end{longtable}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}23}]:} \PY{n}{column\PYZus{}names\PYZus{}vis3} \PY{o}{=}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Games}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}28}]:} \PY{c+c1}{\PYZsh{} Maak hier je eerste optimalisatie}
         \PY{k}{def} \PY{n+nf}{query\PYZus{}visualisatie3}\PY{p}{(}\PY{n}{connection}\PY{p}{,} \PY{n}{column\PYZus{}names}\PY{p}{,} \PY{n}{jaar1} \PY{o}{=} \PY{l+m+mi}{2000}\PY{p}{)}\PY{p}{:}
             \PY{c+c1}{\PYZsh{} het opstellen }
             \PY{n}{query}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+s2}{        SELECT AVG(t.G)}
         \PY{l+s+s2}{        FROM   Teams as t}
         \PY{l+s+s2}{        WHERE  t.yearID = }\PY{l+s+si}{\PYZob{}\PYZcb{}}
         \PY{l+s+s2}{        GROUP BY t.park}
         \PY{l+s+s2}{        }\PY{l+s+s2}{\PYZdq{}\PYZdq{}\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{jaar1}\PY{p}{)}
             \PY{c+c1}{\PYZsh{} Stap 2 \PYZam{} 3}
             \PY{n}{res} \PY{o}{=} \PY{n}{run\PYZus{}query}\PY{p}{(}\PY{n}{connection}\PY{p}{,} \PY{n}{query}\PY{p}{)}         \PY{c+c1}{\PYZsh{} Query uitvoeren}
             \PY{n}{df} \PY{o}{=} \PY{n}{res\PYZus{}to\PYZus{}df}\PY{p}{(}\PY{n}{res}\PY{p}{,} \PY{n}{column\PYZus{}names}\PY{p}{)}          \PY{c+c1}{\PYZsh{} Query in DataFrame brengen}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}29}]:} \PY{n}{username} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{root}\PY{l+s+s1}{\PYZsq{}}      \PY{c+c1}{\PYZsh{} Vervang dit als je via een andere user queries stuurt}
         \PY{n}{hostname} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{localhost}\PY{l+s+s1}{\PYZsq{}} \PY{c+c1}{\PYZsh{} Als je een databank lokaal draait, is dit localhost.}
         \PY{n}{db} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{lahman2016test}\PY{l+s+s1}{\PYZsq{}}      \PY{c+c1}{\PYZsh{} Naam van de gegevensbank op je XAMPP Mysql server}
...
········
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}30}]:} \PY{c+c1}{\PYZsh{} De voorbeeldquery heeft dezelfde kolomnamen als query 1, dus we gebruiken die}
         \PY{n}{kolommen} \PY{o}{=} \PY{n}{column\PYZus{}names\PYZus{}vis3}
         
         \PY{c+c1}{\PYZsh{} Functie uitvoeren, geeft resultaat van de query in een DataFrame}
         \PY{n}{df} \PY{o}{=} \PY{n}{query\PYZus{}visualisatie3}\PY{p}{(}\PY{n}{c}\PY{p}{,} \PY{n}{column\PYZus{}names\PYZus{}vis3}\PY{p}{,} \PY{n}{jaar1} \PY{o}{=} \PY{l+m+mi}{2000}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{df}\PY{p}{)}
         \PY{c+c1}{\PYZsh{} We inspecteren de eerste paar resultaten (voor alles te zien: laat .head() weg)}
         \PY{n}{df}\PY{o}{.}\PY{n}{head}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}30}]:}       Teams
         0  162.0000
         1  162.0000
         2  163.0000
         3  162.0000
